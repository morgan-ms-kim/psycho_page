...
import { TestProvider, useTestContext } from '/components/context/TestContext';
...
export default function MobileTestFrame({ TestComponent, testId }) {
  ...
  // useEffect(() => {
  //   axios.get(`/api/tests/${testId}/comments`).then(res => setComments(res.data));
  //   axios.get(`/api/tests/${testId}/likes`).then(res => setLikes(res.data.count));
  //   axios.get('/api/user/me').then(res => setUser(res.data)).catch(() => setUser(null));
  // }, [testId]);
